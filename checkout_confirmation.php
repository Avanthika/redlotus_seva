...
?>
  ...
  <div class="contentText">
	<div style="float: left;"><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL'), 'primary'); ?></div>
  <div style="float: right;">
	...
	<div style="float: center; width: 60%; padding-top: 5px; padding-left: 15%;">
