...
//--></script>
    ...
    <table border="0" width="100%"  background="file:///C|/wamp/www/seva/ext/jquery/ui/redmond/images/ui-bg_glass_85_dfeffc_1x400.png"cellspacing="0" cellpadding="2">
      <tr>
...
?>
          ...
          <tr>
            ...
            <td class="main" style="padding-left: 30px;">
              <div><?php echo '<strong>' . TEXT_PRODUCTS_MAIN_IMAGE . ' <small>(' . SMALL_IMAGE_WIDTH+20 . ' x ' . SMALL_IMAGE_HEIGHT+20 . 'px)</small></strong><br />' . (tep_not_null($pInfo->products_image) ? '<a href="' . DIR_WS_CATALOG_IMAGES . $pInfo->products_image . '" target="_blank">' . $pInfo->products_image . '</a> &#124; ' : '') . tep_draw_file_field('products_image'); ?></div>
...
?>
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td class="main"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . $products_image_name, $pInfo->products_name, SMALL_IMAGE_WIDTH+20, SMALL_IMAGE_HEIGHT+20, 'align="right" hspace="5" vspace="5"') . $pInfo->products_description; ?></td>
      </tr>
<?php
...
<?php
    ...
    echo HEADING_TITLE_GOTO . ' ' . tep_draw_pull_down_menu('cPath', tep_get_category_tree(), $current_category_id, 'onmouseover="this.form.submit();"');
    echo tep_hide_session_id() . '</form>';
?>
                </td>
              </tr>
      ...
      default:
        if ($rows > 0) {
          if (isset($cInfo) && is_object($cInfo)) { // category info box contents
            ...
            $contents[] = array('text' => '<br />' . tep_info_image($pInfo->products_image, $pInfo->products_name, SMALL_IMAGE_WIDTH+20, SMALL_IMAGE_HEIGHT+20) . '<br />' . $pInfo->products_image);
