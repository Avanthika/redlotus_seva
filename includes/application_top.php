...
// set the language
  if (!tep_session_is_registered('language') || isset($HTTP_GET_VARS['language'])) {
    if (!tep_session_is_registered('language')) {
      tep_session_register('language=english');
      tep_session_register('languages_id=1');
    }
...
if ($products_options_total['total'] != 1) {
   ...
   //end of that fix
        ...
        // maintainance and Qns : Harishyam :> [email="feenix_666@yahoo.com"]feenix_666@yahoo.com[/email]         
