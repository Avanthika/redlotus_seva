    ...
    function bm_categories() {
     ...
     function tep_show_category($counter) {
      ...
      for ($i=0; $i<$tree[$counter]['level']; $i++) {
        $categories_string .= tep_draw_separator('pixel_black.gif', '100%', '1');
      }

      $categories_string .= '<ul><li><a href="';
      ...
      if (isset($cPath_array) && in_array($counter, $cPath_array)) {
        $categories_string .= '<span class="current">';
      }

// display category name
      if (tep_has_category_subcategories($counter)) {
      $categories_string .= tep_image('ext/category_menu/plus.png', '') . tep_draw_separator('pixel_trans.gif', '5', '5');
      }
    	else {
      ...
      if (SHOW_COUNTS == 'true') {
        ...
        if ($products_in_category > 0) {
          $categories_string .= '&nbsp;<span class="count">(' . $products_in_category . ')</span>';
        }
      }
      ...
      $categories_string .= '</span></a></li></ul>';
    ...
    function getData() {
      ...
      $this->tep_show_category($first_element);
        ...
        $data = '<div class="ui-widget infoBoxContainer">' .
              ...
              '  <div class="categorymenu">' . $categories_string . '</div>' .
              '</div>';
      return $data;
    }
